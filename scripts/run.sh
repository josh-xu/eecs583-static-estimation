...
opt -load=${so_module_path} -path-profile-loader -path-profile-loader-file=llvmprof.out -StaticEstimatorPass ${benchmark_exec}.bc

echo "*** moving CSV file"
mv feature_output.csv $CURRENT_DIR/features_files/${benchmark_exec}.csv
